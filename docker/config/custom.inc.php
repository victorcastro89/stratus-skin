...
// SQLite database connection (matches volume mount in docker-compose.yml)
$config['db_dsnw'] = 'sqlite:////var/roundcube/db/sqlite.db?mode=0646';

$config['htmleditor'] = 1;
$config['default_list_mode'] = 'threads';
$config['reply_mode'] = 1;
$config['plugins'] = ['stratus_helper', 'calendar'];


// Archive folder — required for archive plugin to load its JS and register the command.
// Without this (or a user preference), the plugin is effectively disabled.
