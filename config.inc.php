...
$config['plugins'] = ['xskin','xsignature','xquote','xnews_feed','xmultibox','xdropbox','xgoogle_drive','xlast_login','xemail_schedule','xcompose','xcalendar','xbackground','xai','cpanellogin','cpanellogout','archive','calendar','return_to_webmail','markasjunk'];
