 ...
 * Source: roundcubemail/skins/stratus/images/thumb.png  (any size/RGBA)
...
const src  = path.join(root, 'roundcubemail/skins/stratus/images/thumb.png');
const dest = path.join(root, 'roundcubemail/skins/stratus/thumbnail.png');
