 ...
 * Source: skins/stratus/images/thumb.png  (any size/RGBA)
...
const src  = path.join(root, 'skins/stratus/images/thumb.png');
const dest = path.join(root, 'skins/stratus/thumbnail.png');
